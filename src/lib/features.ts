...
export const FLAGS = {
  ...
  // Source TTS (hear the source text read aloud while drafting) — the audio is
  // generated by fluent-ai, so same contract again: defaults to whether AI is
  // wired when EN_FEATURE_SOURCE_TTS is unset.
  sourceTts: { env: 'EN_FEATURE_SOURCE_TTS', default: aiIsWired },
...
export const featuresSchema = z
  .object({
    ...
    sourceTts: z.boolean().openapi({ example: false }),
  })
