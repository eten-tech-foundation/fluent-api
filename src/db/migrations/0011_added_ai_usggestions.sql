...
CREATE UNIQUE INDEX "uq_ai_jobs_range" ON "ai"."ai_suggestion_jobs" USING btree ("project_unit_id","bible_id","book_code","chapter_number","verse_start","verse_end");--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_ai_suggestions_per_text_unit" ON "ai"."ai_suggestions" USING btree ("bible_text_id","project_unit_id");