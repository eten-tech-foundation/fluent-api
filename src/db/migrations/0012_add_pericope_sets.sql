...
CREATE UNIQUE INDEX "idx_pericope_verses_set_book_chapter_verse" ON "pericope_verses" USING btree ("pericope_set_id","book_id","chapter_number","verse_number");--> statement-breakpoint
